...
- [x] G2: Deterministic suite — 11/11 harness offline + 49/49 pytest at 92.32% coverage
...
- [x] G8: Public browser isolation — clean state per browser session; cross-session reads, overwrites, and approvals blocked inside the POC instance (Aug 28)
...
- **Current: G1–G8 + R1 + F1–F2 PASSED. Deploy/hosted recheck, R2 recording, and S1–S2 remain.**
